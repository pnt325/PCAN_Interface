...
begin
  microsTimestamp := (itsTimeStamp.micros + 1000 * itsTimeStamp.millis + $100000000 * 1000 * itsTimeStamp.millis_overflow);

  writeln('Type: ' + GetMsgTypeString(msg.MSGTYPE));
  writeln('ID: ' + GetIDString(msg.ID,msg.MSGTYPE));
  writeln('Length: ' + msg.LEN.ToString());
...
begin
  writeln('Type: ' + GetMsgTypeString(msg.MSGTYPE));
  writeln('ID: ' + GetIDString(msg.ID,msg.MSGTYPE));
  writeln('Length: ' + GetLengthFromDLC(msg.DLC).ToString());
